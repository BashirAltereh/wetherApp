package com.example.bashir.wetherapp.PagerRecycler;
...
import com.example.bashir.wetherapp.MainActivity;
import com.example.bashir.wetherapp.R;
...
public class RecyclerViewPager extends RecyclerView {
    ...
    int mMinLeftWhenDragging = Integer.MIN_VALUE;
  ...
  /*  @Override
   ...
   /* @Override
    ...
    public boolean fling(int velocityX, int velocityY) {
        ...
        if (flinging) {
            if (getLayoutManager().canScrollHorizontally() && MainActivity.isLandScape) {
    ...
    /* @Override
     public void onScrollStateChanged(int state) {
         ...
         if (state == SCROLL_STATE_DRAGGING) {
             ...
             mMinLeftWhenDragging = Integer.MIN_VALUE;
             mMaxTopWhenDragging = Integer.MIN_VALUE;
             mMinTopWhenDragging = Integer.MIN_VALUE;
         }
     }
 */
